...
if (isset($_POST['search']['value'])) {
    ...
    $query .= " WHERE  income_name like '%" . $search_value . "%' ";
    $query .= " OR  income_amount like '%" . $search_value . "%' ";

}
$column_order = array('id', 'income_name', 'income_amount', );
...
while ($row = mysqli_fetch_assoc($run_result)) {
    $sub_data = array();
    $sub_data[] = $row["income_name"];
    $sub_data[] = '&#8358;' . number_format($row["income_amount"], 2);
