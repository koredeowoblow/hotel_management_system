    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="p1 modal-title">Add income</h5>
            ...
            <div class="modal-body">
                ...
                <form id="myform">
                    ...
                    <div class="form-group">
                        <p style="font-size: 14px;color:#242424;margin-bottom: 2px;font-weight: 400;">income amount:</p>
                        <input type="number" name="total_amount" class="form-control" id="total_amount">
                    </div>
                    <button type="submit" class=" btn btn-block btn-primary" style="float:right;">add income
                    </button>
                </form>
            </div>
...
<div class="modal fade" id="updatenew">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mods">update income</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <i class="anticon anticon-close"></i>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form id="myforms">
                    ...
                    <button type="submit" class=" btn btn-block btn-primary" style="float:right;">update income
                    </button>
                </form>
            </div>
            <div class="modal-footer">
    ...
    $(document).on('click', '#editbtn', function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("input[name='total_amounts']").val(json.income_amount);
            }
        })
    });
